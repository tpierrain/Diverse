...
namespace Diverse
{
    ...
    public class Fuzzer : IFuzz
    {
        ...
        /// <summary>
        /// Returns a <see cref="IFuzz"/> instance that you can use to generate always different values
        /// (compared to the previous one generated by this specific instance).
        ...
        public IFuzz GenerateFuzzerAlwaysReturningDifferentValues()
        {
